...
// Задача 1: Функция-колбэк
// Напиши функцию filterArray, которая принимает массив чисел и функцию-колбэк. 
// Функция-колбэк должна возвращать true или false в зависимости от того, подходит ли элемент под определённое условие. 
// filterArray должна возвращать новый массив, содержащий только те элементы, для которых колбэк вернул true.
...
// Задача 2: Замыкания
// Создай функцию makeCounter, которая возвращает другую функцию, увеличивающую счётчик на 1 каждый раз, когда она вызывается. 
// Счётчик должен сохранять своё значение между вызовами.
// Функция makeCounter должна создавать переменную, которая будет хранить текущее значение счётчика.
// Каждый раз, когда возвращаемая функция вызывается, она должна увеличивать это значение на 1 и возвращать его.
