...
// Решает передачу методов Объекта как колбэков, передаем не ссылку на оригинальный метод а его привязанную версию с контекстом!
// call просто вызывает сдесь и сейчас а bind сможет передать внутрь ссылку на эту функцию!
