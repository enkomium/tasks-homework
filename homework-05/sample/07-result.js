...
// Короче говоря нельзя обратиться к приватному свойству по типу ( созданныйОбъект.приватное свойство ) - console.log(myCar.#model);
// А к публичному можно!
// ------------------------------------------------------------------------------------------------------------------------------------
...
// ПРИМЕР ОТЛИЧИЯ статических свойств и методов от публичных и приватных
...
//     // Статическое публичное свойство
//     static maxSpeed = 200;
  
//     // Статический приватный свойство
//     static #discountPercentage = 10;
  
//     // Статический публичный метод
//     static calculateDiscount(price) {
//       return price * (1 - Car.#discountPercentage / 100);
//     }
//   }
...
//   console.log(myCar.brand); // Вывод: Toyota
  
//   // Нельзя обратиться к приватному свойству извне класса
//   // console.log(myCar.#model); // Ошибка: SyntaxError
  
//   // Вызываем публичный метод
//   console.log(myCar.getInfo()); // Вывод: Brand: Toyota, Model: Camry
  
//   // Обращаемся к статическому публичному свойству
//   console.log(Car.maxSpeed); // Вывод: 200
  
//   // Нельзя обратиться к статическому приватному свойству извне класса
//   // console.log(Car.#discountPercentage); // Ошибка: SyntaxError
  
//   // Вызываем статический публичный метод
//   console.log(Car.calculateDiscount(1000)); // Вывод: 900

// То есть разница в том что Статические это для КЛАССА а публичные для Экземпляра и всего.
// К Приватным можно обращаться только через Методы а к бубличным на прямую! 
// ------------------------------------------------------------------------------------------------------------------------------------
