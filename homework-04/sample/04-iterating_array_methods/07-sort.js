...
// Сортировка в обратном порядке. При возвращении меняем местами числа.
// numbers.sort((a, b) => {
//   return b - a;
// });
// console.log(numbers);
...
// Создание копии!
// Этот метод изменяет Оригинал, если надо сделать копию, у нас есть slice или ...spred
// + короткая запись!
// const descSortedNumbers = [...numbers].sort((a, b) => b - a); /* на убывание */
// const ascSortedNumbers = [...numbers].sort((a, b) => a - b); /* на возраст */
// console.log('копия на убывание', descSortedNumbers);
// Соритровать в обратном порядке можно используя reverse от уже готового противоположного значения
// ----------------------------------------------------------------
...
// Сортировка на порвой букве Имени
