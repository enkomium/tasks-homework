...
// - Возвращает НОВЫЙ МАССИВ такой же длины, на место результата ставит то что вернула функция во все элементы
// - Используется что-бы вытянуть что-то, какой-то 1 или Обновить элементы старой коллекции, подменить на новые
