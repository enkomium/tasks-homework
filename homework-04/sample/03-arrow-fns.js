...
// this (контекст) у стрелочных Функций ссылается на то где ты ее Объявил!
// В нашем Примере Метод вызывается в контексте ОБъекта,
//  стрелочная функция лежит в методе и тоже будет ссылаться на то что и метод, будет ссылаться на то же что и ее контекст (метод)
// Стрелки не бывают методами ОБъекта, они могут быть в нутри метода и запоминать их контекст!
// Так же стрелки не могут быть функцией-кончтруктором
// const user = {
//   fullName: 'Mango',
//   ShowName() {
