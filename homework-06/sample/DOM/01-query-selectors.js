...
// Потом подключается Скрипт и мы работаетм с этим Деровом.
...
// ----------------------------------------------------------------
// СПОСОБ ПОИСКА ПО CSS СЕЛЕКТОРАМ!!!
// const cheeseElement = document.querySelector('#categories li.item ul li:nth-child(3)');
...
// document.querySelectorAll и document.querySelector ищуют во всем документе
